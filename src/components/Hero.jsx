...
function Hero() {
  ...
  <div className="flex flex-col items-center justify-center h-screen absolute left-[18%] top-[9rem] ">
      ...
      <a href="#" className="text-white shadow-lg  uppercase font-bold stroke-black  bg-pink px-20 py-3 rounded-full   hover:text-gray-200">
                Presale
              </a>
